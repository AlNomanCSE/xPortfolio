...
import CheckedIcon from "@/../public/icons/check-circle.svg";
import RightArrowIcon from "@/../public/icons/arrow-up-right.svg";
    ...
    <section className="pb-16 lg:py-24">
      <div className="container">
        <div className="flex justify-center">
          <p className="uppercase font-semibold tracking-widest md:text-2xl bg-gradient-to-r from-emerald-300 to-sky-400 text-center bg-clip-text text-transparent">
            Real-world Results
          </p>
        </div>
        ...
        <p className="text-center md:text-lg lg:text-xl text-white/60 mt-4">
          See how I transformed concepts onto engaging digital experiences.
        </p>
